...
All current public MCP tools have explicit `readOnlyHint`, `openWorldHint`, and `destructiveHint` annotations. FastMCP also generates an output schema for every public tool.
